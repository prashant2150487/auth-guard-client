    ...
    <header className="border-b border-white/10  bg-slate-950 text-white sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link to="/permission" className="text-sm text-white/70 hover:text-white transition">Permission</Link>
            <a href="/users" className="text-sm text-white/70 hover:text-white transition">Users</a>
            <a href="#pricing" className="text-sm text-white/70 hover:text-white transition">Pricing</a>
            <a href="#docs" className="text-sm text-white/70 hover:text-white transition">Documentation</a>
          </nav>
